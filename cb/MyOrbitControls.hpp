...
#ifndef MYTHREEPP_ORBITCONTROLS_HPP
#define MYTHREEPP_ORBITCONTROLS_HPP
...
//namespace threepp {
    ...
    public:
        ...
        MyOrbitControls(Camera& camera, OpenGLCanvas& canvas);
...
#endif//MYTHREEPP_ORBITCONTROLS_HPP
